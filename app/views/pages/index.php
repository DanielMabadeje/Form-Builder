...
<div style="text-align:center;">
  ...
  <div class="position-relative overflow-hidden p-5 m-0  text-center bg-whit landing-bg pt-0 mt-md-0" style="background: linear-gradient(to bottom right, rgb(253, 251, 251),rgb(253, 251, 251), rgba(253, 249, 249, 0)), url('<?=URLROOT?>/img/jess-bailey-q10VITrVYUM-unsplash.jpg'); background-size:cover; height:100%;">
