...
<div style="text-align:center;">
  ...
  <div class="position-relative overflow-hidden p-5 m-0  text-center bg-whit landin pt-0 mt-md-0" style="background-image: linear-gradient(rgb(253, 251, 251), rgba(253, 249, 249, 0.8)), url(' http://localhost/cubbiccle/img/rahul-chakraborty-xsGxhtAsfSA-unsplash.jpg'); background-size:cover;">
